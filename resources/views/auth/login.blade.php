            ...
            <div class="leading-loose">
                ...
                <form method="POST" action="{{ route('login') }}" class="max-w-xl m-4 p-10 bg-white rounded shadow-xl">
                    ...
                    <div class="">
                        ...
                        <div class="col-md-6">
                            <input class="w-full px-5 py-1 text-gray-700 bg-gray-200 rounded" id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus>
