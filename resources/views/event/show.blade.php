        ...
        <div class="container-fluid" id="container-wrapper">
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Tampilan Data Event</li>
                </ol>
            </div>
                ...
                <div class="card-body">
                    <form action="" method="POST">
                        <div class="form-group">
                            ...
                            <input class="form-control  mb-3" type="text" name="nama_event" value="{{ $event->nama_event }}" disabled>
                        </div>

                        <div class="form-group">
                            <label class="form-label">Tanggal Diselengarakan</label>
                            <input class="form-control  mb-3" type="text" name="tanggal" value="{{ $event->tanggal }}" disabled>
                        </div>
