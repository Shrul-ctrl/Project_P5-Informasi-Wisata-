...
<div class="content-1 card text-bg-dark">
    <img src="images/bromo-header-2.avif" class="card-img" alt="...">
    ...
    <div class="content-4">
        <div class="">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">Jawa</li>
                {{-- <li class="breadcrumb-item active" aria-current="page">Kategori</li> --}}
            </ol>
        </div>

        <div class="judul">
            <h1 class="a">Ibu Kota dan Ragam Budaya di Pulau Jawa</h1>
            ...
            <h1 class="b">Telusuri Wisata diJawa</h1>
        </div>
        <div class="row row-cols-1 row-cols-md-5 g-4">
            @foreach ($jawa as $data)
                <div class="col">
