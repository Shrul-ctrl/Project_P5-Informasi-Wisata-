    ...
    <div class="content-4">
        <div class="">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">Sulawesi</li>
                {{-- <li class="breadcrumb-item active" aria-current="page">Kategori</li> --}}
            </ol>
        </div>

        <div class="judul">
            <h1 class="a">Sulawesi: Tempat Petualangan Menanti</h1>
            <p>Sulawesi menyajikan keajaiban alam, mulai dari Buaken hingga Tana Toraja, yang akan membuat Anda terkagum-kagum..</p>
            <hr class="border-dark border-2 ">
            <h1 class="b">Telusuri Wisata diSulawesi</h1>
        </div>
        <div class="row row-cols-1 row-cols-md-5 g-4">
            @foreach ($sulawesi as $data)
                <div class="col">
